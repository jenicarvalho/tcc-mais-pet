        ...
        <div class="col-md-3 col-sm-12">
          <div class="ownerInformation">
            <div class="ownerPicture">
              <img src="assets/img/astor.png" class="ownerPicture">
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-3 col-sm-4">
                <div class="featuredPicture">
                  <img src="assets/img/astor.png" class="paddingCard">
                </div>
              </div>
                  ...
                  <div id="myCarousel" class="carousel slide sliderPosition" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="item active">
                        <img src="assets/img/astor1.JPG" alt="Astor">
                      </div>
                      <div class="item">
                        <img src="assets/img/astor2.JPG" alt="Astor">
                      </div>
                      <div class="item">
                        <img src="assets/img/astor3.JPG" alt="Astor">
                      </div>
                    </div>
