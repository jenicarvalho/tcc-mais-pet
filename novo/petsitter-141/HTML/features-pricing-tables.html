...
<head>
	...
	================================================== -->
	<meta charset="utf-8">
	<title>Pricing Tables | PetSitter Responsive HTML5/CSS3 Template</title>
		...
		<header class="header header-menu-fullw">
			...
			<div class="header-main">
				<div class="container">
					<!-- Logo -->
					<div class="logo">
						<a href="index.html"><img src="images/logo.png" alt="PetSitter"></a>
			      ...
			      <div class="head-info">
			      	<ul class="head-info-list">
			      		<li><span>Call us on:</span> +1 (234) 567890</li>
			      		<li><span>Email:</span> <a href="mailto:petsitter@dan-fisher.com">petsitter@dan-fisher.com</a></li>
			      	</ul>
					...
					<ul data-breakpoint="992" class="flexnav">
						...
						<li class="active"><a href="#">Features</a>
							<ul>
								...
								<li class="active"><a href="features-pricing-tables.html">Pricing Tables</a></li>
								<li><a href="features-typography.html">Typography</a></li>
								<li><a href="features-columns.html">Columns</a></li>
								<li><a href="features-icons.html">Icons</a></li>
							</ul>
						</li>
						<li><a href="#">Pet Sitters</a>
							<ul>
						...
						<li><a href="portfolio-3cols.html">Portfolio</a>
							<ul>
								...
								<li><a href="portfolio-single-halfwidth.html">Single Half Width</a></li>
								<li><a href="portfolio-single-fullwidth.html">Single Full Width</a></li>
							</ul>
						</li>
			...
			<footer class="footer" id="footer">
									...
									<div class="widget-content">
										...
										<form action="php/newsletter-form.php" method="POST" id="newsletter-form">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<button type="submit" class="btn btn-success btn-block" data-loading-text="Loading...">Subscribe</button>
												</div>
											</div>
										</form>
									</div>
				...
				<div class="footer-copyright">
					<div class="container">
						<div class="row">
							<div class="col-sm-6 col-md-4">
								Copyright &copy; 2014  <a href="index.html">PetSitter</a> &nbsp;| &nbsp;All Rights Reserved
							</div>
